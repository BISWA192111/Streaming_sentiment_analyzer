...
def add_shared_args(parser):
    ...
    parser.add_argument('--model', type=str, default='base', choices="tiny.en,tiny,base.en,base,small.en,small,medium.en,medium,large-v1,large-v2,large-v3,large,large-v3-turbo".split(","),help="Name size of the Whisper model to use (default: base). The model is automatically downloaded from the model hub if not present in model cache dir.")
